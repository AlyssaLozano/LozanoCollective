  ...
  return (
    <section id="about" className="bg-[#F5F1E8] py-28 md:py-40 overflow-hidden">
      <div className="px-6 md:px-12 lg:px-20 max-w-screen-xl mx-auto">
        ...
        <div
          ref={imgRef}
          className="opacity-0 translate-y-8 transition-all duration-1000 ease-out mb-20 grid grid-cols-1 md:grid-cols-2 gap-4"
        >
          <div className="rounded-2xl overflow-hidden" style={{ height: '420px' }}>
            <img
              src="https://readdy.ai/api/search-image?query=Professional%20woman%20educator%20in%20a%20modern%20college%20classroom%20setting%2C%20warm%20natural%20lighting%2C%20teaching%20cybersecurity%20or%20technology%2C%20confident%20and%20approachable%20presence%2C%20cream%20and%20warm%20earth%20tones%2C%20editorial%20documentary%20photography%20style%2C%20authentic%20academic%20environment%2C%20sophisticated%20but%20natural&width=700&height=460&seq=about_img_01&orientation=landscape"
              alt="Alyssa Lozano — educator, researcher, leader"
              className="w-full h-full object-cover object-top"
            />
          </div>
          <div className="rounded-2xl overflow-hidden" style={{ height: '420px' }}>
            <img
              src="https://storage.readdy-site.link/project_files/b5779f47-cadb-49df-8244-c7ee24f8547b/f907f9f4-35af-43a1-9929-93b7c53a9f9a_DSC_9435.jpeg?v=29e5015f913ffce495fd719860a8d10e"
              alt="Alyssa Lozano"
              className="w-full h-full object-cover object-top"
            />
          </div>
