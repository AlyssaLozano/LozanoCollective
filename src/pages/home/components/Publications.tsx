...
const books = [
  {
    ...
    coverUrl: 'https://m.media-amazon.com/images/I/71kxqhNMSQL._SY466_.jpg',
    coverBg: '#0D1A2E',
    coverAccent: '#C9A84C',
    comingSoon: false,
  },
      ...
      <div className="px-6 md:px-12 lg:px-20 max-w-screen-xl mx-auto">
        ...
        >
          <p
            ...
            style={{ fontFamily: 'Cormorant Garamond, serif' }}
          >
            &ldquo;The most dangerous thing in cybersecurity is not the adversary — it&apos;s the assumption that someone else is handling it.&rdquo;
          </p>
          <p
